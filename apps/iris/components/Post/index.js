...
import parseDate from 'apps/iris/src/helpers/parseDate';
import {
  FaRegClock,
  FaFacebookF,
  FaTwitter,
...
import generateFluidObject from 'apps/iris/src/helpers/generateFluidObject';
              ...
              {post.users &&
                post.users.map((user, i, arr) => (
                  <React.Fragment key={i}>
                    <Link
                      passHref href={`/author/${user.slug}`}>
                      <a
                        sx={{
                          fontWeight: 'medium',
