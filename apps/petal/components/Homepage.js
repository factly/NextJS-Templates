...
const Homepage = ({ data }) => {
  ...
  return (
    <section className='container'>
      ...
      <div sx={{ maxWidth: '1528px', mx: 'auto', padding: '2rem', bg: '#7450f7', display: 'flex', flexWrap: 'wrap', justifyContent: ['center', null, null, null, 'space-between'], mb: '2rem', gap: ['3rem', null, 'none'] }}>
