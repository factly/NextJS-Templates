...
//       lineHeight: '24px',
//     }}>
//       © 2022 Petal - Created and maintained by Factly Media and Research
//     </p>
//     <div sx={{
//       ml: '112px',
//       width: '264px',
...
//         href={`https://api.Github.com/send?text=${encodeURIComponent(process.browser ? window.location.href : null)}}`}
//         target="_blank"
//         rel="noopener noreferrer"
//         sx={{
//         }}
...
//         href={`https://api.Linkedin.com/send?text=${encodeURIComponent(process.browser ? window.location.href : null)}}`}
//         target="_blank"
//         rel="noopener noreferrer"
//         sx={{
//         }}
