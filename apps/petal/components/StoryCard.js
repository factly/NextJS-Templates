          ...
          >
            <Link href={`/${storyData.slug}`}>
              <div sx={{ maxWidth: '100%', width: '100%', display: 'flex', overflow: 'hidden' }}>
                <div
                  sx={{
                    paddingBottom: '62.50%', overflow: 'hidden', position: 'relative', width: '100%',
                  }}
                >
                  <div
                    sx={{
                      position: 'absolute', width: '100%', height: ' 100%', background: '#eff8fa',
                    }}
                  >
                    <img
                      sx={{
                        width: '100%', height: '100%', boxShadow: ' 0px 24px 48px -12px rgba(16, 24, 40, 0.18)', alignSelf: 'stretch',
                      }}
            ...
            >
              {storyData?.categories?.length > 0 && (
                <Link key={storyData.id} href={`/category/${storyData.categories[0].slug}`} passHref>
                  <a
                    sx={{
                      width: '384px', height: '20px', fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 600, fontSize: '14px', lineHeight: '20px', color: '#F77E41', marginBottom: '16px', alignSelf: 'stretch',
                    }}
                  >
              ...
              <div
                sx={{
                  display: 'flex', flexDirection: 'row', alignItems: 'center', padding: '0px', gap: '12px', marginTop: '24px'
                ...
                <div
                  ...
                  <img src="{storyData.medium?.url}" alt="" />
                </div>
                <div sx={{
                  display: 'flex', flexDirection: 'column', alignItems: 'flexStart', padding: '0px'
                }}>
                  <div sx={{
                    fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 500, fontSize: '14px', lineHeight: '20px', color: '#101828',
                  }}>
                    <Link key={storyData.id} href={`/author/${storyData?.users[0]?.slug}`} passHref>
                      <a sx={{}}>

                        <p>  {storyData?.users[0]?.display_name}</p>
                      </a>
                    </Link>
                  </div>
                  <div>
                    <p sx={{
                      fontFamily: 'Inter', fontStyle: 'normal', fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#667085',
