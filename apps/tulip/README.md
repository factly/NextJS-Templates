<h1 align="center">
  @factly/NextJS-theme-tulip
</h1>

Tulip is a Next.js project built with an NX workspace that provides a newspaper and magazine theme.

Site link:([https://stag-tulip.netlify.app])
